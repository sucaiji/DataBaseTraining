...
public class SplashActivity extends AppCompatActivity implements SplashADListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            fetchSplashAD(this, container, skipView, AppInfo.APPID, AppInfo.SPLASH, this, 0);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 1024 && hasAllPermissionsGranted(grantResults)) {
            ...
            Toast.makeText(this, "抱歉，应用需要权限才可以运行.请点击\"权限\",打开所需要的权限.不会对您的手机造成损害的(*^_^*)", Toast.LENGTH_LONG).show();
